#=========================================================================
# Processor and Sort Xcel
#=========================================================================
# Author : Jack Brzozowski
# Date   : February 28th, 2022
#
# ProcXcel with the Sort Accelerator
#
...
def construct():
  ...
  parameters = {
    ...
    'sim_path'        : f"{this_dir}/../../app",
    'design_path'     : f"{this_dir}/../../sim/pmx",
    'design_name'     : 'ProcXcel_sort2_rtl',
    'clock_period'    : 3.0,
    'clk_port'        : 'clk',
    'reset_port'      : 'reset',
    'adk'             : adk_name,
    ...
    # VCS-sim
    'test_design_name': 'ProcXcel_sort2_rtl',
    'input_delay'     : 0.05,
    'output_delay'    : 0.05,
    ...
    # PT Power
    'saif_instance'   : 'ProcXcel_sort2_rtl_tb/DUT',
  }
