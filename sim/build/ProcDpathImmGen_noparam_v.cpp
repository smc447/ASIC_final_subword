//========================================================================
// VProcDpathImmGen_noparam_v.cpp
//========================================================================
...
#include "obj_dir_ProcDpathImmGen_noparam/VProcDpathImmGen_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_ProcDpathImmGen_noparam/VProcDpathImmGen_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VProcDpathImmGen_noparam_t *, char * );
  #endif
...
VProcDpathImmGen_noparam_t * create_model( const char *vcd_filename ) {

  VProcDpathImmGen_noparam_t * m;
  VProcDpathImmGen_noparam   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VProcDpathImmGen_noparam_t *) malloc( sizeof(VProcDpathImmGen_noparam_t) );
  model = new VProcDpathImmGen_noparam();
...
void destroy_model( VProcDpathImmGen_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VProcDpathImmGen_noparam * model = (VProcDpathImmGen_noparam *) m->model;
...
void comb_eval( VProcDpathImmGen_noparam_t * m ) {
...
void seq_eval( VProcDpathImmGen_noparam_t * m ) {
...
#if VLINETRACE
void trace( VProcDpathImmGen_noparam_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_ProcDpathImmGen_noparam__v );
