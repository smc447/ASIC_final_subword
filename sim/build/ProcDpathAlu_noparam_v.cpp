...
#include "obj_dir_ProcDpathAlu_noparam/VProcDpathAlu_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_ProcDpathAlu_noparam/VProcDpathAlu_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VProcDpathAlu_noparam_t *, char * );
  #endif
...
VProcDpathAlu_noparam_t * create_model( const char *vcd_filename ) {

  VProcDpathAlu_noparam_t * m;
  VProcDpathAlu_noparam   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VProcDpathAlu_noparam_t *) malloc( sizeof(VProcDpathAlu_noparam_t) );
  model = new VProcDpathAlu_noparam();
...
void destroy_model( VProcDpathAlu_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VProcDpathAlu_noparam * model = (VProcDpathAlu_noparam *) m->model;
...
void comb_eval( VProcDpathAlu_noparam_t * m ) {
...
void seq_eval( VProcDpathAlu_noparam_t * m ) {
...
#if VLINETRACE
void trace( VProcDpathAlu_noparam_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_ProcDpathAlu_noparam__v );
