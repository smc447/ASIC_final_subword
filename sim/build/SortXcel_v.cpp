...
#include "obj_dir_SortXcel/VSortXcel.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SortXcel/VSortXcel__Syms.h"
#include "svdpi.h"
#endif
...
VSortXcel_t * create_model( const char *vcd_filename ) {
  ...
  m     = (VSortXcel_t *) malloc( sizeof(VSortXcel_t) );
  model = new VSortXcel();
...
void destroy_model( VSortXcel_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSortXcel * model = (VSortXcel *) m->model;
...
#if VLINETRACE
void trace( VSortXcel_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_SortXcel__v );
