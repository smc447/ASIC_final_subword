...
#include "obj_dir_ProcDpathAluWrapper/VProcDpathAluWrapper.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_ProcDpathAluWrapper/VProcDpathAluWrapper__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VProcDpathAluWrapper_t;

  // Exposed methods
  VProcDpathAluWrapper_t * create_model( const char * );
  void destroy_model( VProcDpathAluWrapper_t *);
  void comb_eval( VProcDpathAluWrapper_t * );
  void seq_eval( VProcDpathAluWrapper_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VProcDpathAluWrapper_t *, char * );
  #endif
...
VProcDpathAluWrapper_t * create_model( const char *vcd_filename ) {

  VProcDpathAluWrapper_t * m;
  VProcDpathAluWrapper   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VProcDpathAluWrapper_t *) malloc( sizeof(VProcDpathAluWrapper_t) );
  model = new VProcDpathAluWrapper();
...
void destroy_model( VProcDpathAluWrapper_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VProcDpathAluWrapper * model = (VProcDpathAluWrapper *) m->model;
...
void comb_eval( VProcDpathAluWrapper_t * m ) {
...
void seq_eval( VProcDpathAluWrapper_t * m ) {
...
#if VLINETRACE
void trace( VProcDpathAluWrapper_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_ProcDpathAluWrapper__v );
