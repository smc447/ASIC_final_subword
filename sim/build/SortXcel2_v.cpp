...
#include "obj_dir_SortXcel2/VSortXcel2.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SortXcel2/VSortXcel2__Syms.h"
#include "svdpi.h"
#endif
...
VSortXcel2_t * create_model( const char *vcd_filename ) {
  ...
  m     = (VSortXcel2_t *) malloc( sizeof(VSortXcel2_t) );
  model = new VSortXcel2();
...
void destroy_model( VSortXcel2_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSortXcel2 * model = (VSortXcel2 *) m->model;
...
#if VLINETRACE
void trace( VSortXcel2_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_SortXcel2__v );
