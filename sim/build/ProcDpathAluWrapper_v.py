...
class ProcDpathAluWrapper( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libProcDpathAluWrapper_v.so', os.path.getmtime( './libProcDpathAluWrapper_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libProcDpathAluWrapper_v.so')

    # increment instance count
    ProcDpathAluWrapper.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "ProcDpathAluWrapper.verilator1.vcd"
    ...
    s.s_DOT_istream_DOT_msg = Wire( Bits70 )
    @update
    ...
    s.s_DOT_ostream_DOT_msg = Wire( Bits35 )
    @update
    ...
    def comb_upblk():
      ...
      x[2] = int(s.s_DOT_istream_DOT_msg[64:70])
