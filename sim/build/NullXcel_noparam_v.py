...
class NullXcel_noparam( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libNullXcel_noparam_v.so', os.path.getmtime( './libNullXcel_noparam_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libNullXcel_noparam_v.so')

    # increment instance count
    NullXcel_noparam.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "NullXcel_noparam.verilator1.vcd"
