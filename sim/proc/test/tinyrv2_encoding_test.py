...
def test_tinyrv2_inst_add8():
  check( "add8   x1,  x2,  x3",      0b01001000001100010000000011110111, "add8   x01, x02, x03" )
  check( "add8   x01, x02  x03",     0b01001000001100010000000011110111, "add8   x01, x02, x03" )

def test_tinyrv2_inst_sub8():
  check( "sub8   x1,  x2,  x3",      0b01001010001100010000000011110111, "sub8   x01, x02, x03" )
  check( "sub8   x01, x02  x03",     0b01001010001100010000000011110111, "sub8   x01, x02, x03" )
